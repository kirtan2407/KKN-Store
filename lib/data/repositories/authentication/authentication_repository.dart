...
//       }
//     } catch (e) {
//       if       child: const Text('Resend Email', style: TextStyle(color: Colors.white)),
//           ),
//         );
//       } else {
...
//       if (res.user != null) {
//         // Save User Data to Firestore/Supabase
//         await UserRepository.instance.saveUserRecord(
//             res.user!, fullName, phoneNumber, email, username, gender, dob ?? '');
  ...
  Future<void> registerWithEmailPassword(
    ...
    try {
      ...
      if (res.user != null) {
        ...
        Get.snackbar('Success', 'Account created. Verify your email.');
      }
    } catch (e) {
      Get.snackbar('Error', e.toString());
    }
